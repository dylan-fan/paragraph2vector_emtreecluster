...
class ClusterStats : public ClusterVisitor<SVector<double>> {
public:
    ...
    void accept(const int level, const SVector<double>* parentCluster,
            const SVector<double>* cluster, const double RMSE, const uint64_t objectCount) {
